...
export default function FloatingWhatsapp() {
  ...
  // Ciclo de animación: Abre por 3.5s -> Cierra por 25s
  useEffect(() => {
  ...
  return (
    ...
    >
      <a
        href="https://wa.me/5491176617374?text=Hola!%20Me%20gustar%C3%ADa%20que%20me%20ayudes%20a%20crear%20mi%20tienda%20online%20en%20Catalagox."
        target="_blank"
      ...
      >
        <FaWhatsapp className="text-2xl sm:text-3xl text-white flex-shrink-0" />
        ...
        <AnimatePresence initial={false}>
          {isExpanded && (
            <motion.span
              ...
              className="overflow-hidden whitespace-nowrap font-semibold text-xs sm:text-sm text-white pr-1"
            >
